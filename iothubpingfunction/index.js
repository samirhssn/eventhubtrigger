...
var connectionString =
  "HostName=iinvApp.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=BIPDcsu6shGnnwpdS87tIoTEfNbrqzsHI1sxKiGUYLM=";

module.exports = function (context, myEventHubTrigger) {
  context.log(
    "Received raw message from device " + JSON.stringify(myEventHubTrigger)
  );
  ...
  client.open(function (err) {
    if (err) {
      ...
      context.log(
        "Sending message: " + message.getData() + "to: " + jsonMessage.deviceId
      );
      client.send(
        jsonMessage.deviceId,
        message,
        printResultFor("send", context)
      );
    }
    context.done();
  });
